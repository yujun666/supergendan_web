$(function(){
	...
	showForm("cargoForm");//默认赋值上一次填的内容



///////////////////////获取表单内容//////////////////////////////
function getFormData(){
	var formData=serializeForm("cargoForm");
	...
	// 单位处理
	formData.unit1=formData.unit1=="米"?"m":"kg";
	...
	localStorage.setItem("cargoForm",data);//表单数据本地存储
	localStorage.setItem("formData",data);//表单数据本地存储
	localStorage.setItem("orderType","1");//大货
	console.log(formData)
