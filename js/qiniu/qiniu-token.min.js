...
!(function(){
  var qiniuToken = qiniuToken || function(){};
  var p = qiniuToken.prototype;
  p.config = {
    access_key:"",
    secret_key:"",
    bucketname:""
  };
  p.put_policy_encode = function(){
    var deadline = parseInt ( (Date.parse(new Date)) / 1000 ) + 3600;
    var json_text = '{"scope":"' + p.config.bucketname + '","deadline":' + deadline + '}';
    return json_text;
  }
  p.getUpToken = function(){
    var accessKey = p.config.access_key,
        secretKey=p.config.secret_key,
        put_policy = p.put_policy_encode();
  ...
  window.qiniuToken = new qiniuToken;
})()
