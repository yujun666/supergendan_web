$("#qiniu").after("<script language='javascript' src='js/qiniu/qiniu.js'></script>");
$("#qiniu").after("<script language='javascript' src='js/qiniu/qiniu-token.min.js'></script>");
$("#qiniu").after("<script language='javascript' src='js/plupload/plupload.full.min.js'></script>");
// $("#qiniu").after("<script language='javascript' src='js/plugins/jquery.min.js'></script>");
